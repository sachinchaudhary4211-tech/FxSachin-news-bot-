...
WEBHOOK_URL = os.getenv("https://discord.com/api/webhooks/1540670407517151283/tTW18ucJttskrE68l-C8o_57zEyAYAzdrsbufv9V0YzuTss7EhpBCc-vTz-526ATtpFl")
...
SENT_EVENTS_FILE = "sent_usd_events.json"

# Alert up to 30 minutes before event
ALERT_WINDOW_MINUTES = 30

# USD impact levels to send
ALLOWED_IMPACTS = [
    "High",
    "Medium",
    "Low"
...
def main():
    ...
    print(
        "Fetching USD economic calendar..."
    )
